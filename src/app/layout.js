...
//           {/* Tea Auction Ticker - placed below the header */}
//           <div className="w-full bg-gradient-to-r from-green-600 to-green-700 text-white">
//             <SaleTicker />
//           </div>
//         </div>
...
//           className="flex-grow pt-32 md:pt-36 px-4 container mx-auto"
//         >
//           {children}
//         </motion.main>
...
//         <h3 className="text-xl font-bold text-green-400 border-b border-green-400 pb-2">Mercantile Produce Brokers (Pvt)Ltd</h3>
//         <p className="text-gray-300">Specialty tea brokers with a legacy of quality and excellence in Sri Lanka tea industry.</p>
//         <div className="flex space-x-4 pt-2">
//           <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-300 hover:text-green-400 transition-colors duration-300">
//             <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
//               <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path>
//             </svg>
//           </a>
//           <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-300 hover:text-green-400 transition-colors duration-300">
//             <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
//             </svg>
//           </a>
//           <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-300 hover:text-green-400 transition-colors duration-300">
//             <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
//       {/* Contact Information */}
//       <div>
//         <h3 className="text-lg font-semibold mb-4 text-green-400 border-b border-green-400 pb-2">Head Office</h3>
...
//       <div>
//         <h3 className="text-lg font-semibold mb-4 text-green-400 border-b border-green-400 pb-2">Warehouse</h3>
//         <address className="not-italic text-gray-300 space-y-2">
//           <p>No. 220, Padiliyathuduwa Road</p>
//           <p>Enderamulla, Wattala</p>
//           <p>Phone: 0112 981 418</p>
//         </address>
//       </div>

//       {/* Sample Room Information */}
//       <div>
//         <h3 className="text-lg font-semibold mb-4 text-green-400 border-b border-green-400 pb-2">Sample Room</h3>
//         <address className="not-italic text-gray-300 space-y-2">
//           <p>No. 220/A/3B, Diyabubulawatta</p>
//           <p>Enderamulla, Wattala</p>
//           <p>Phone: 0112 943 497</p>
//         </address>
//       </div>
//     </div>
...
//     {/* Copyright */}
//     <div className="pt-6 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
//       <p>&copy; {new Date().getFullYear()} Mercantile Produce Brokers (Pvt) Ltd. All rights reserved.</p>
//       <p className="mt-2 md:mt-0">Developed by <span className="text-green-400">MPBL-IT</span></p>
//     </div>
//   </div>
// </footer>
//       </body>
