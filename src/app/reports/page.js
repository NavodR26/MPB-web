...
export default function Reports() {
  ...
  const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzmbRcQOY1nljP6XEkSS-qFLqdnEWGIrIs037FsnB3N5xX5eNVA5MWLTgiQA5vOY-J_/exec";
  ...
  const fetchReports = useCallback(async () => {
    ...
    try {
      ...
      // Sort by sale number (newest first) as backup in case Apps Script sorting fails
      const sortedData = [...data].sort((a, b) => b.saleNumber - a.saleNumber);
      
      setReports(sortedData);
      setFilteredReports(sortedData);
      setSelectedReport(sortedData[0] || null);
      setError(null);
      ...
      setFilteredReports(
        reports.filter(report => {
          ...
          return (
            ...
            report.formattedSaleNo.toString().includes(searchTerm)
          );
        })
      );
    }
  ...
  return (
    ...
    >
      ...
      {!isLoading && !error && reports.length > 0 && (
        ...
        >
          <motion.div variants={itemVariants} className="mb-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="relative w-full md:w-auto md:flex-1 max-w-md">
              <FaSearch className="absolute left-3 top-3 text-green-600" />
              <input
                type="text"
                placeholder="Search reports by name or sale number..."
                value={searchTerm}
            ...
            {lastUpdated && (
              <div className="text-sm text-gray-500 whitespace-nowrap">
                Last updated: {formatReportDate(lastUpdated)}
              </div>
            )}
          </motion.div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <iframe
                  ...
                  title={`PDF Preview: ${selectedReport.name}`}
                ...
                <div className="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Sale No: {selectedReport.formattedSaleNo}
                      <br />
                      Created: {formatReportDate(selectedReport.createdTime)}
                      <br />
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <a
                      href={`${selectedReport.downloadUrl}&t=${new Date().getTime()}`}
